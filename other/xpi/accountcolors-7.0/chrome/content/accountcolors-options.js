...
var accountColorsOptions =
{
    ...
    initPrefs: function()
    {
        ...
        if (accountColorsOptions.versionComparator.compare(accountColorsOptions.appInfo.version,"5.0a1") >= 0) accountColorsOptions.tbVersion = "5.0";
        ...
        checkbox = document.getElementById("accountcolors-compose-colorfieldbkgd");
        try
        {
            checkstate = accountColorsOptions.prefs.getBoolPref("compose-colorfieldbkgd");
            checkbox.checked = checkstate;
        }
        catch(e)
        {
    ...
    savePrefs: function()
    {
        ...
        accountColorsOptions.prefs.setBoolPref("compose-colorfieldbkgd",document.getElementById("accountcolors-compose-colorfieldbkgd").checked);
